...
@Component({
  selector: 'nga-app-subject-modal-delete',
  templateUrl: './subject-modal-delete.component.html',
  styleUrls: ['./subject-modal-delete.component.scss']
})
export class SubjectModalDeleteComponent implements OnInit {
  data: any;
  modalHeader: string;
  form: FormGroup;
  ...
  onSubmit({ value, valid }: { value: any, valid: boolean }) {
    if (valid) {
      this.subjectsService.delete(this.data.data)
        .subscribe(res => {
          if (res.success) {
