...
@Component({
  selector: 'nga-app-directed-practice-modal-delete',
  templateUrl: './directed-practice-modal-delete.component.html',
  styleUrls: ['./directed-practice-modal-delete.component.scss']
})
export class DirectedPracticeModalDeleteComponent implements OnInit {
  data: any;
  modalHeader: string;
  form: FormGroup;
