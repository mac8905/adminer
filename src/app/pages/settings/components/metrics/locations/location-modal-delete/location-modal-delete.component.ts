...
@Component({
  selector: 'nga-app-location-modal-delete',
  templateUrl: './location-modal-delete.component.html',
  styleUrls: ['./location-modal-delete.component.scss']
})
export class LocationModalDeleteComponent implements OnInit {
  data: any;
  modalHeader: string;
  form: FormGroup;
