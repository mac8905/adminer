...
@Component({
  selector: 'nga-app-practical-type-modal-edit',
  templateUrl: './practical-type-modal-edit.component.html',
  styleUrls: ['./practical-type-modal-edit.component.scss']
})
export class PracticalTypeModalEditComponent implements OnInit {
  data: any;
