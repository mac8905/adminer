...
@Component({
  selector: 'nga-app-practical-type-modal-create',
  templateUrl: './practical-type-modal-create.component.html',
  styleUrls: ['./practical-type-modal-create.component.scss']
})
export class PracticalTypeModalCreateComponent implements OnInit {
  modalHeader: string;
  formPracticalType: FormGroup;
  ...
  ngOnInit() {
    this.formPracticalType = this.fb.group({
      name: ['', Validators.required],
      description: [''],
      type: ['practical_type', Validators.required],
    });
  }
