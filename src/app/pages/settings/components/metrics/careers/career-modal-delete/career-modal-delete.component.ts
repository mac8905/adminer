...
@Component({
  selector: 'nga-app-career-modal-delete',
  templateUrl: './career-modal-delete.component.html',
  styleUrls: ['./career-modal-delete.component.scss']
})
export class CareerModalDeleteComponent implements OnInit {
  data: any;
  modalHeader: string;
  form: FormGroup;
