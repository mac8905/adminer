...
@Component({
  selector: 'nga-app-practice-modal-in-process',
  templateUrl: './practice-modal-in-process.component.html',
  styleUrls: ['./practice-modal-in-process.component.scss']
})
export class PracticeModalInProcessComponent implements OnInit {
  data: any;
  form: FormGroup;
      ...
      this.practicesService.updateStatus(value)
        .subscribe(res => {
          if (res.success && res.data) {
            this._notificationsService.success('Transacción exitósa', 'Estado de la práctica finalizado.');
